...
<div id="sidebar" class="active">
  <div class="sidebar-wrapper active ps ps--active-y">
    ...
    <div class="sidebar-menu">
      <ul class="menu">
        <li class="sidebar-title fs-5">Menu</li>
        ...
        <li class="sidebar-item  <?= @$menu3 ?>">
          <a href="paket_laundry.php" class="sidebar-link">
            <i class="bi bi-box-seam"></i>
            <span>Paket Laundry</span>
          </a>
        </li>
        <li class="sidebar-item  <?= @$menu4 ?>">
          <a href="detail_transaksi.php" class="sidebar-link">
...
<?php
$id = $_SESSION['id'];
$penguna = "SELECT * FROM tb_user where id = $id";
$execpenguna = mysqli_query($conn, $penguna);
$datapenguna = mysqli_fetch_assoc($execpenguna);
?>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <div class="dropdown">
            <a href="#" data-bs-toggle="dropdown" aria-expanded="false">
              <div class="user-menu d-flex">
                <div class="user-name text-end me-3">
                  <h6 class="mb-0 text-gray-600"><?= $datapenguna['nama'] ?></h6>
                  <p class="mb-0 text-sm text-gray-600"><?= $datapenguna['role'] ?></p>
                </div>
            ...
            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton" style="min-width: 11rem;">
              <li>
                <h6 class="dropdown-header">Hello, <?= $datapenguna['nama'] ?>!</h6>
              </li>
